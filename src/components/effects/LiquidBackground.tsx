...
export function LiquidBackground() {
    ...
    return (
        <div className="fixed inset-0 -z-10 bg-[#000502] overflow-hidden pointer-events-none">
            ...
            <motion.div
                className="absolute w-[1200px] h-[1200px] bg-emerald-900/10 rounded-full blur-[150px] opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                animate={{
                    scale: [1, 1.1, 1],
                    opacity: [0.2, 0.3, 0.2],
                }}
            ...
            <motion.div
                className="absolute w-[600px] h-[600px] bg-cyan-500/20 rounded-full blur-[100px] opacity-40 mix-blend-screen left-1/2 top-1/2"
                style={{
                    x: initialX,
                    y: initialY,
                }}
            ...
            <motion.div
                className="absolute w-[200px] h-[200px] bg-white/10 rounded-full blur-[50px] opacity-60 mix-blend-overlay left-1/2 top-1/2"
                style={{
                    x: coreX,
                    y: coreY,
                }}
            ...
            <motion.div
                className="absolute w-[800px] h-[800px] bg-emerald-600/20 rounded-full blur-[120px] opacity-25 top-[-20%] left-[-10%] mix-blend-screen"
                animate={{
                    x: [0, 80, -20, 0],
                    y: [0, 50, -30, 0],
                    scale: [1, 1.15, 0.95, 1],
            ...
            <motion.div
                className="absolute w-[700px] h-[700px] bg-teal-600/20 rounded-full blur-[100px] opacity-25 bottom-[-10%] right-[-10%] mix-blend-screen"
                animate={{
                    x: [0, -60, 20, 0],
                    y: [0, -80, 40, 0],
                    scale: [1, 1.25, 1],
            ...
            <motion.div
                className="absolute w-[1000px] h-[600px] bg-indigo-800/20 rounded-[100%] blur-[130px] opacity-20 bottom-[-30%] left-[20%] mix-blend-color-dodge"
                animate={{
                    x: [0, 50, -50, 0],
                    y: [0, -30, 30, 0],
                    opacity: [0.2, 0.3, 0.2]
